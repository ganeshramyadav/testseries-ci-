              ...
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    <tr>
                        <?php if($route == "subcategory"){
                            echo "<th>Sub Categories</th>";
                        }?>
                    ...
                    <tr>
                        ...
                        <td><?php if($record->active == 1){ echo "Active";}else{echo "InActive";} ?></td>
                        ...
                        <td class="text-center">
                            ...
                            <!-- <a class="btn btn-sm btn-danger delete" href="#" data-userid="<?php //echo $record->id; ?>" data-msg="<?php //echo $title; ?>" data-url="<?php //echo $route; ?>" title='Delete'><i class="fa fa-trash"></i></a> -->
                        </td>
                    </tr>
                    <?php
                        }
