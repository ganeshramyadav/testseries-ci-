                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" placeholder="Test Series Name" name="title" value="<?php echo $Info->Name; ?>" maxlength="128">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="noe" placeholder="Number Of Examination" name="noe" value="<?php echo $Info->no_of_exam; ?>" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="isPublic" id="free" value="1" <?php if($Info->isPublic == true){ echo "checked"; } ?>>
                                                Free (For All Student)
                                            </label>
                                            <p></p>
                                            <label>
                                                <input type="radio" name="isPublic" id="paid" value="0" <?php if($Info->isPublic == false){ echo "checked"; } ?>>
