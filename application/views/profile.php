                ...
                <div class="box box-warning">
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                                <b>Mobile</b> <a class="pull-right"><?php echo $mobile ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="fname" name="fname" placeholder="<?php echo $userInfo->first_name; ?>" value="<?php echo set_value('fname', $userInfo->first_name); ?>" maxlength="128" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="lname" name="lname" placeholder="<?php echo $userInfo->last_name; ?>" value="<?php echo set_value('lname', $userInfo->last_name); ?>" maxlength="128" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
