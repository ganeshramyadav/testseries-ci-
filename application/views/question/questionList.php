                ...
                <div class="box">
                    <div class="box-header" style="text-align: -webkit-center;">
                        ...
                        <form action="<?php echo base_url() . $route ?>" method="POST" id="searchList">
                            <input type="hidden" value="1" name="pageValue"/>
                            ...
                            <tbody>
                                <?php if(!empty($Records)){
                                    foreach($Records as $record){
                                        // pre($record);
                                        // pre (json_decode($record->answers));
                                        if(json_decode($record->answers)->correct_answer == 'option_1'){
                                            $options = "A";
                                        }
                                        if(json_decode($record->answers)->correct_answer == 'option_2'){
                                            $options = "B";
                                        }
                                        if(json_decode($record->answers)->correct_answer == 'option_3'){
                                            $options = "C";
                                        }
                                        if(json_decode($record->answers)->correct_answer == 'option_4'){
                                            $options = "D";
                                        }
                                        if(json_decode($record->answers)->correct_answer == 'option_5'){
                                            $options = "E";
                                        }
                                ?>
                                        <tr>
                                            ...
                                            <td><?php echo (json_decode($record->answers)->option_1) ?></td>
                                            <td><?php echo (json_decode($record->answers)->option_2) ?></td>
                                            <td><?php echo (json_decode($record->answers)->option_3) ?></td>
                                            <td><?php echo (json_decode($record->answers)->option_4) ?></td>
...
<script>
    ...
    jQuery(document).ready(function() {
        jQuery('#subcategory').change(function(e) {
            e.preventDefault();
            var link = jQuery(this).get(0).href;
            jQuery("#searchList").attr("action", baseURL + "<?php echo $route; ?>");
            jQuery("#searchList").submit();
        });
    });
