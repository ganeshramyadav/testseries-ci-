...
insert  into `category`(`id`,`name`,`created_at`,`updated_at`,`active`,`created_by`) values (1,'maths_new','2019-10-19 09:33:15','2019-11-18 12:30:33',1,1),(2,'computer',NULL,NULL,1,NULL),(3,'physics',NULL,NULL,1,NULL),(4,'hindi',NULL,NULL,1,NULL),(5,'english',NULL,NULL,1,NULL),(6,'net','2019-11-13 10:40:36','2019-11-13 15:10:36',0,1),(7,'general knowledge','2019-11-17 09:36:26','2019-11-17 14:06:26',1,1);
...
insert  into `exam`(`id`,`institute_id`,`title`,`duration`,`active`,`created_by`,`created_at`,`updated_at`,`category_id`,`subcategory_id`,`no_of_question`,`year`) values (1,13,'railway',30,1,1,'2019-11-14 12:50:57',NULL,1,1,4,2019),(2,13,'psc',35,1,1,'2019-11-14 12:51:45','2019-11-18 17:11:04',2,2,6,2019);
...
insert  into `exam_question`(`id`,`question_id`,`exam_id`,`active`,`created_at`,`updated_at`) values (1,16,1,1,'2019-11-14 23:46:43',NULL),(5,11,2,1,'2019-11-14 23:46:52',NULL),(10,7,2,1,'2019-11-16 14:32:48','2019-11-16 14:32:48'),(11,8,2,1,'2019-11-16 14:32:57','2019-11-16 14:32:57'),(20,15,1,1,'2019-11-16 23:56:51','2019-11-16 23:56:51');
...
CREATE TABLE `test_questions` (
  ...
  PRIMARY KEY (`id`),
  KEY `Test_questions_FK` (`question_id`),
  KEY `Test_questions_FK_1` (`test_series_id`),
  CONSTRAINT `Test_questions_FK` FOREIGN KEY (`question_id`) REFERENCES `questions` (`id`),
  CONSTRAINT `Test_questions_FK_1` FOREIGN KEY (`test_series_id`) REFERENCES `testseries` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
